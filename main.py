...
def analysis():
    ...
    try:
        ...
        messagebox.showerror("missing data","Missing few data entries !!")
        return
    ...
    if(prediction[0]==0):
        ...
        report1.config(text=f"{name}, you do have a heart disease")
...
fbs = IntVar()
R1 = Radiobutton(Detail_entry, text="True", variable=fbs, value=1, command=selection2)
R2 = Radiobutton(Detail_entry, text="False", variable=fbs, value=2, command=selection)
R1.place(x=213,y=10)
R2.place(x=263,y=10)
...
cp_combobox=Combobox(Detail_entry,values=['0 = typical angina','1 = atypical angina','2 = non-anginal pain','3 = asymptomatic'],state="r",width=15,font="arial 12")
restecg_combobox=Combobox(Detail_entry,values=['0','1','2'],state="r",width=11,font="arial 12")
slope_combobox=Combobox(Detail_entry,values=['0 = upsloping','1 = flat','2 = downsloping'],state="r",width=12,font="arial 12")
ca_combobox=Combobox(Detail_entry,values=['0','1','2','3','4'],state="r",width=15,font="arial 12")
thal_combobox=Combobox(Detail_entry,values=['0','1','2','3'],state="r",width=14,font="arial 12")
...
Button(root,image=analysis_button,bg=background,bd=0,cursor='hand2',command=analysis).place(x=1130,y=240)

############### info button ########################

info_button = PhotoImage(file="images/info.png")
Button(root,image=info_button,bg=background,bd=0,cursor='hand2',command=info).place(x=10,y=240)

################### save button #########################

save_button = PhotoImage(file="images/save.png")
Button(root,image=save_button,bg=background,bd=0,cursor='hand2',command=Save).place(x=1370,y=250)
